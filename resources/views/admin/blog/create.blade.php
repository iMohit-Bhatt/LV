                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('content') is-invalid @enderror" 
                                                  id="content" name="content" rows="15" placeholder="Write your blog content here...">{{ old('content') }}</textarea>
                                        @error('content')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('category') is-invalid @enderror" 
                                            ...
                                            <option value="Valuation" {{ old('category') == 'Valuation' ? 'selected' : '' }}>Valuation</option>
