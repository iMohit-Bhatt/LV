...
@section('content')
    <div class="hero page-inner overlay" style="background-image: url('scss/images/landacquisition.jpg')">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-9 text-center mt-5">
                    <h1 class="heading" data-aos="fade-up">Acquisition Land</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        <div class="container">
            <div class="row d-flex mt-5">
                <div class="col-lg-4"><img src="{{ asset('scss/images/img_9.jpg') }}" alt="Your Partner in Strategic Property Investment"
                        class="img-fluid" /></div>
                <div class="col-lg-8 pt-3">
                    <p class="text-black mb-3 mt-5"><b>Your Strategic Ally for Industrial Land Acquisition in Noida: </b>In
                        the rapidly evolving industrial landscape of Noida, Uttar Pradesh, Ekansh Realty stands as your
                        trusted partner, simplifying the often complex process of land acquisition for industrialization. We
                        understand the critical importance of selecting the optimal site for your business growth and
                        expansion within this key economic zone. Our dedicated team provides expert guidance through every
                        stage, from meticulously identifying potential land parcels that align with your specific industrial
                        requirements and zoning regulations within Noida, to skillfully navigating negotiations and ensuring
                        a seamless acquisition process.</p>
                    <p class="text-black mb-3"><b>Comprehensive Expertise from Site Selection to Infrastructure Development
                            in the Noida Region: </b>Our expertise extends beyond simply finding available land in Noida.
                        Ekansh Realty offers comprehensive support that encompasses both strategic site selection and
                        meticulous oversight of essential infrastructure projects. We leverage our deep understanding of the
                        local regulatory environment, connectivity options, and the evolving industrial ecosystem of Noida
                        and the surrounding Uttar Pradesh region. This allows us to identify land parcels with inherent
                        advantages and ensure that the necessary infrastructure, including power, water, and transportation
                        links, are in place or can be efficiently developed to support your industrial operations within
                        this key investment hub.</p>
                </div>
            </div>
        </div>
    </div>
