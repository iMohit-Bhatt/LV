                    ...
                    <div class="property-item d-block">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="property-content">
                                    <div class="price mb-2"><span class="d-block">ATS Kingston Heath <br /><br /></span>
                                    </div>
                                    <span class="d-block mb-2 text-black-50">Residential</span>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="property-content">
                                    <div class="price mb-2"><span class="d-block">ATS Knightsbridge <br /><br /></span>
                                    </div>
                                    <span class="d-block mb-2 text-black-50">Residential</span>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <div class="property-content">
                                    <div class="price mb-2"><span class="d-block">ATS Le Grandiose<br /><br /></span>
                                    </div>
                                    <span class="d-block mb-2 text-black-50">Residential</span>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="property-content">
                                    <div class="price mb-2"><span class="d-block">ATS Pious Hideaways <br /><br /></span>
                                    </div>
                                    <span class="d-block mb-2 text-black-50">Residential</span>
                    ...
                    <div class="property-item d-block">
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <div class="property-content">
                                    <div class="price mb-2"><span class="d-block">ATS Pious Orchards<br /><br /></span>
                                    </div>
                                    <span class="d-block mb-2 text-black-50">Residential</span>
                                    <span class="d-block mb-2 text-black-50">Noida, Uttar Pradesh, 201310</span>
                                    <div class="specs mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="property-content">
                                    <div class="price mb-2"><span class="d-block">ATS Kabana High <br /><br /></span>
                                    </div>
                                    <span class="d-block mb-2 text-black-50">Residential</span>
